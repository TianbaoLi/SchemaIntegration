...
#include "DiskReadWrite/buf_common.h"
#include "DiskReadWrite/db.h"
#include "DiskReadWrite/bufmgr.h"
#include "stdio.h"
...
void DiskRW(char fileRead[], char fileWrite[]){

	char* page = NULL;

	FILE* in = fopen(fileRead, "r");

	char filename[100];
	strcpy(filename,fileWrite);
...
int main()
{
	char fileFrom[100]="a.txt";
	char fileTo[100]="test.txt";
	DiskRW(fileFrom,fileTo);
	return 0;
}
